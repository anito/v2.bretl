...
get_header(); ?>
		...
		<section id="primary" class="<?php echo ( ( vendipro()->widgets->get_widget_count( 'vp_blog' ) > 0 && vp_has_sidebar( 'vp_blog' ) ) ? 'has-sidebar' : '' );?>">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title"><?php
						printf( __( '%s', 'vendipro' ), '<span>' . single_cat_title( '', false ) . '</span>' );
					?></h1>
